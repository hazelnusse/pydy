...
# Constants
parameter_list = symbols("m g r1 t I J")
m, g, r1, t, I, J = parameter_list

#I = m*r1**2/2  # Central moment of inertia about any diameter
#J = m*r1**2    # Central moment of inertia about normal axis
...
N.setcoords(q_list, qdot_list, u_list)
...
CO = N.O.locate('CO', -r1*B[3], frame=C, mass=m)

# Fixed inertial reference point
N1 = CO.locate('N1', r1*B[3] - q1*N[1] - q2*N[2])
...
# Resulting equations of motion are extremely long and messy
#u_rhs = qdot_list[2:]
...
for qd in dependent_rates:
    dependent_rates[qd] = trigsimp(dependent_rates[qd])
...
#f = lambdify(u_list, [kindiffs[qd] for qd in qdot_list[2:]])
